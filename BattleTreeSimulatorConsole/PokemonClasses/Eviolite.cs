...
namespace BattleTreeSimulatorConsole.PokemonClasses
{
    class Eviolite : IPokemon
    {
        ...
        public short Defense { get => pokeRound(pokemon.Defense * 1.5); set => pokemon.Defense = value; }
        public short SpecialAttack { get => pokemon.SpecialAttack; set => pokemon.SpecialAttack = value; }
        public short SpecialDefense { get => pokeRound(pokemon.SpecialDefense * 1.5); set => pokemon.SpecialDefense = value; }
        public short Speed { get => pokemon.Speed; set => pokemon.Speed = value; }
